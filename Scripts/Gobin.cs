...
public class Gobin : MonoBehaviour
{
    ...
    int face=3;
    float attackTime=0;
    Vector2 yuanOffset=new Vector2(0.282f,-0.648f);
    Vector2 yuanSize=new Vector2(1.446f,2.409f);
    Vector2 houOffset=new Vector2(0.0760f,-0.2816f);
    Vector2 houSize=new Vector2(10.28661f,4.7916f);
    [SerializeField]float blood=10f;
