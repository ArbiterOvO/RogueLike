...
public class Skeleton : MonoBehaviour
{
    ...
    int face=3;
    float attackTime=0;
    Vector2 yuanOffset=new Vector2(0.595f,0.17737f);
    Vector2 yuanSize=new Vector2(1.611f,4.0224f);
    Vector2 houOffset=new Vector2(4.519f,0.5128f);
    Vector2 houSize=new Vector2(9.458f,5.860f);
    [SerializeField]float blood=30f;
    // Start is called before the first frame update
    void Start()
    {
